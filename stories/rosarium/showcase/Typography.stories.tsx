...
const TypographyDemo: React.FC<PropsWithChildren> = () => {
  return (
    <>
      <p className="rosarium-hero">Messa da Requiem</p>
      <RosariumHeading level={1}>Introitus, Kyrie, Sequentia</RosariumHeading>
      <p className="rosarium-paragraph">Requiem aeternam dona eis, Domine, et lux perpetua luceat eis. <a className="rosarium-link">Te decet hymnus, Deus, in Sion</a>, et tibi reddetur votum in Jerusalem. Exaudi orationem meam, ad te omnis caro veniet. Requiem aeternam dona ets, Domine, et lux perpetua luceat ets. Kyrie eleison, Christe eleison, kyrie eleison.</p>
